"""
Django settings for biblioteca_virtua project.
...
SECRET_KEY = 'django-insecure-!n!7y(d)oy)6-ccaxv_@pt&1+o*1-^h5z37j=k9g2$3r1zwidm'
...
WSGI_APPLICATION = 'biblioteca_virtua.wsgi.application'
...
if IS_TESTING:
    ...
    # Usar SQLite en memoria para tests (más rápido y sin problemas de permisos)
    DATABASES = {
        'default': {
    ...
    print("⚙️ MODO PRODUCCIÓN: Usando MySQL")
